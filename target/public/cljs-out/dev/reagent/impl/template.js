...
var G__10099 = o;
(G__10099[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__10101__i < G__10101__a.length) {G__10101__a[G__10101__i] = arguments[G__10101__i + 0]; ++G__10101__i;}
  args = new cljs.core.IndexedSeq(G__10101__a,0,null);
} 
...
var G__10105 = jsprops;
(G__10105["defaultValue"] = value);

(G__10105["onChange"] = ((function (G__10105,v,value,on_change){
return (function (p1__10104_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__10104_SHARP_);
});})(G__10105,v,value,on_change))
);
...
var vec__10108 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10108,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10108,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10108,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___10112 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___10112 == null)){
} else {
var key_10113 = temp__5461__auto___10112;
(jsprops["key"] = key_10113);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__10114 = reagent.impl.template.__GT_NativeWrapper();
(G__10114["name"] = c);
...
var G__10115 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__10115) : reagent.impl.template.as_element.call(null,G__10115));
} else {
...
var len__4531__auto___10120 = arguments.length;
var i__4532__auto___10121 = (0);
while(true){
if((i__4532__auto___10121 < len__4531__auto___10120)){
args__4534__auto__.push((arguments[i__4532__auto___10121]));

var G__10122 = (i__4532__auto___10121 + (1));
i__4532__auto___10121 = G__10122;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10118){
var G__10119 = cljs.core.first(seq10118);
var seq10118__$1 = cljs.core.next(seq10118);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10119,seq10118__$1);
});
...
break;
default:
var G__10125 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__10125;
continue;
...
var n__4408__auto___10127 = a.length;
var i_10128 = (0);
while(true){
if((i_10128 < n__4408__auto___10127)){
(a[i_10128] = reagent.impl.template.as_element((a[i_10128])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4408__auto___10130 = a.length;
var i_10131 = (0);
while(true){
if((i_10131 < n__4408__auto___10130)){
var val_10132 = (a[i_10131]);
if(((cljs.core.vector_QMARK_(val_10132)) && ((reagent.impl.template.key_from_vec(val_10132) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_10131] = reagent.impl.template.as_element(val_10132));
...
var ctx = ({});
var vec__10134 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10134,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10134,(1),null);
...
var G__10137 = (cljs.core.count(argv) - first_child);
switch (G__10137) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__10137){
