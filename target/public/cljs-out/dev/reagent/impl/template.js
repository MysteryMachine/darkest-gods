...
var G__20320 = o;
(G__20320[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__20322__i < G__20322__a.length) {G__20322__a[G__20322__i] = arguments[G__20322__i + 0]; ++G__20322__i;}
  args = new cljs.core.IndexedSeq(G__20322__a,0,null);
} 
...
var G__20326 = jsprops;
(G__20326["defaultValue"] = value);

(G__20326["onChange"] = ((function (G__20326,v,value,on_change){
return (function (p1__20325_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__20325_SHARP_);
});})(G__20326,v,value,on_change))
);
...
var vec__20329 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__20329,(0),null);
var id = cljs.core.nth.call(null,vec__20329,(1),null);
var class$ = cljs.core.nth.call(null,vec__20329,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___20333 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___20333 == null)){
} else {
var key_20334 = temp__5461__auto___20333;
(jsprops["key"] = key_20334);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__20335 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__20335["name"] = c);
...
var i__4532__auto___20341 = (0);
while(true){
if((i__4532__auto___20341 < len__4531__auto___20340)){
args__4534__auto__.push((arguments[i__4532__auto___20341]));

var G__20342 = (i__4532__auto___20341 + (1));
i__4532__auto___20341 = G__20342;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq20338){
var G__20339 = cljs.core.first.call(null,seq20338);
var seq20338__$1 = cljs.core.next.call(null,seq20338);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20339,seq20338__$1);
});
...
break;
default:
var G__20345 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__20345;
continue;
...
var n__4408__auto___20347 = a.length;
var i_20348 = (0);
while(true){
if((i_20348 < n__4408__auto___20347)){
(a[i_20348] = reagent.impl.template.as_element.call(null,(a[i_20348])));

var G__20349 = (i_20348 + (1));
i_20348 = G__20349;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___20350 = a.length;
var i_20351 = (0);
while(true){
if((i_20351 < n__4408__auto___20350)){
var val_20352 = (a[i_20351]);
if(((cljs.core.vector_QMARK_.call(null,val_20352)) && ((reagent.impl.template.key_from_vec.call(null,val_20352) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_20351] = reagent.impl.template.as_element.call(null,val_20352));

var G__20353 = (i_20351 + (1));
i_20351 = G__20353;
continue;
} else {
}
...
var ctx = ({});
var vec__20354 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__20354,(0),null);
var derefed = cljs.core.nth.call(null,vec__20354,(1),null);
...
var G__20357 = (cljs.core.count.call(null,argv) - first_child);
switch (G__20357) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__20357){
