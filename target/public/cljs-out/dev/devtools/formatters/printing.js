...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq20892){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20893,G__20894,seq20892__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__20898_SHARP_){
return !((cljs.core.meta.call(null,p1__20898_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__20899__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e20903){var _e__9075__auto__ = e20903;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e20905){var _e__9075__auto__ = e20905;
return false;
}}
})())){
...
var _STAR_current_state_STAR_20907 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__20908 = opts;
...
var markup_db = cljs.core.get.call(null,map__20908__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_20907;
}});
...
;
var temp__5455__auto___20912 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___20912)){
var managed_print_level_20913 = temp__5455__auto___20912;
var _STAR_print_level_STAR_20911_20914 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_20913;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_20911_20914,managed_print_level_20913,temp__5455__auto___20912,writer,opts,job_fn){
return (function (p1__20910_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__20910_SHARP_,null);
});})(_STAR_print_level_STAR_20911_20914,managed_print_level_20913,temp__5455__auto___20912,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_20911_20914;
}} else {
job_fn.call(null);
}
