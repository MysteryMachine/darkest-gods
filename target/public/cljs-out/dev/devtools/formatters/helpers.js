...
var G__9163 = devtools.prefs.pref.call(null,v);
v = G__9163;
continue;
} else {
return v;
...
}catch (e9166){var _e__8149__auto__ = e9166;
return false;
}})();
...
}catch (e9170){var _e__8149__auto__ = e9170;
return false;
}})();
...
}catch (e9172){var _e__8149__auto__ = e9172;
return false;
}}
}
});
...
var vec__9174 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__9174,(0),null);
var name = cljs.core.nth.call(null,vec__9174,(1),null);
...
return cljs.core.some.call(null,(function (p1__9177_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__9177_SHARP_);
}),template);
});
