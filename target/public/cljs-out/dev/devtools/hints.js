...
}catch (e24953){var _e = e24953;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___24956 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___24956)){
var seen_errors_24957 = temp__5455__auto___24956;
if(cljs.core.truth_(seen_errors_24957.has(self))){
} else {
seen_errors_24957.add(self);

var temp__5457__auto___24958 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___24958)){
var sense_24959 = temp__5457__auto___24958;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_24959)].join('');
} else {
}
}
} else {
