...
var o20729 = temp__5455__auto__;
var temp__5455__auto____$1 = (o20729["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o20730 = temp__5455__auto____$1;
return (o20730["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__9068__auto__ = f;
return (o__9068__auto__["toString"]).call(o__9068__auto__);
} else {
return "";
}
}catch (e20731){var _ = e20731;
return "";
}});
...
try{var o__9068__auto___20733 = t;
(o__9068__auto___20733["cljs$lang$ctorPrWriter"]).call(o__9068__auto___20733,t,writer);
}catch (e20732){var __20734 = e20732;
}
...
var char_code = (function (){var o__9068__auto__ = (new String(char$));
return (o__9068__auto__["charCodeAt"]).call(o__9068__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__9068__auto__ = String;
return (o__9068__auto__["fromCharCode"]).call(o__9068__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__20735 = num_code;
switch (G__20735) {
case (1):
return (185);
...
var o__9068__auto__ = String;
return (o__9068__auto__["fromCharCode"]).call(o__9068__auto__,superscript_code);
});
/**
...
}catch (e20737){var _e__9075__auto__ = e20737;
return false;
}})())){
...
var vec__20738 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__20738,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o20741 = temp__5455__auto__;
var temp__5455__auto____$1 = (o20741["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o20742 = temp__5455__auto____$1;
return (o20742["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___20749 = arguments.length;
var i__4532__auto___20750 = (0);
while(true){
if((i__4532__auto___20750 < len__4531__auto___20749)){
args__4534__auto__.push((arguments[i__4532__auto___20750]));

var G__20751 = (i__4532__auto___20750 + (1));
i__4532__auto___20750 = G__20751;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__20745){
var vec__20746 = p__20745;
var ns_detector = cljs.core.nth.call(null,vec__20746,(0),null);
...
var G__20752 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__20753 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__20752;
remaining_tokens = G__20753;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq20743){
var G__20744 = cljs.core.first.call(null,seq20743);
var seq20743__$1 = cljs.core.next.call(null,seq20743);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20744,seq20743__$1);
});
...
var vec__20757 = cljs.core.split_with.call(null,(function (p1__20756_SHARP_){
return cljs.core.not_EQ_.call(null,p1__20756_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__20757,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__20757,(1),null);
...
var vec__20760 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__20760,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__20760,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__20763 = cljs.core.rest.call(null,remaining_tokens);
var G__20764 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__20763;
name_tokens = G__20764;
continue;
} else {
...
var vec__20767 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__20767,(0),null);
var arity = cljs.core.nth.call(null,vec__20767,(1),null);
var vec__20770 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__20770,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__20770,(1),null);
var vec__20773 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__20773,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__20773,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__20773,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__20773,(3),null);
...
var vec__20779 = result;
var munged_ns = cljs.core.nth.call(null,vec__20779,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__20779,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__20779,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__20779,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__20779,(4),null);
var arity = cljs.core.nth.call(null,vec__20779,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__20783 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__20783,(0),null);
var args = cljs.core.nth.call(null,vec__20783,(1),null);
var vec__20786 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__20786,(0),null);
var name = cljs.core.nth.call(null,vec__20786,(1),null);
...
var G__20789 = (arity + (1));
var G__20790 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__20791){
var vec__20792 = p__20791;
var arity = cljs.core.nth.call(null,vec__20792,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__20792,(1),null);
...
return cljs.core.get.call(null,arities,p1__20795_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__20796_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___20803 = arguments.length;
var i__4532__auto___20804 = (0);
while(true){
if((i__4532__auto___20804 < len__4531__auto___20803)){
args__4534__auto__.push((arguments[i__4532__auto___20804]));

var G__20805 = (i__4532__auto___20804 + (1));
i__4532__auto___20804 = G__20805;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__20799){
var vec__20800 = p__20799;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__20800,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq20797){
var G__20798 = cljs.core.first.call(null,seq20797);
var seq20797__$1 = cljs.core.next.call(null,seq20797);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20798,seq20797__$1);
});
...
var map__20808 = options;
var map__20808__$1 = ((((!((map__20808 == null)))?(((((map__20808.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20808.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20808):map__20808);
var include_ns_QMARK_ = cljs.core.get.call(null,map__20808__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__20808__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__20808__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__20808__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__20809 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__20809,(0),null);
var fn_name = cljs.core.nth.call(null,vec__20809,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__20809,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__20809,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__20809,(4),null);
var arity = cljs.core.nth.call(null,vec__20809,(5),null);
...
var o__9068__auto__ = f;
return (o__9068__auto__["getBasis"]).call(o__9068__auto__);
});
/**
...
}catch (e20813){var _e__9075__auto__ = e20813;
...
var G__20814 = (obj[cljs.core.first.call(null,path)]);
var G__20815 = cljs.core.rest.call(null,path);
obj = G__20814;
path = G__20815;
continue;
} else {
...
return (function (accum,p__20816){
var vec__20817 = p__20816;
var bit = cljs.core.nth.call(null,vec__20817,(0),null);
var protocol = cljs.core.nth.call(null,vec__20817,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__20820){
var vec__20821 = p__20820;
var ns = cljs.core.nth.call(null,vec__20821,(0),null);
var name = cljs.core.nth.call(null,vec__20821,(1),null);
var selector = cljs.core.nth.call(null,vec__20821,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__20826,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__20826,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__20826,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__20824_SHARP_){
return (obj[cljs.core.first.call(null,p1__20824_SHARP_)]);
});})(name,sorted_matches,vec__20826,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
