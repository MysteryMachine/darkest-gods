...
var o9061 = temp__5455__auto__;
var temp__5455__auto____$1 = (o9061["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o9062 = temp__5455__auto____$1;
return (o9062["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__8142__auto__ = f;
return (o__8142__auto__["toString"]).call(o__8142__auto__);
} else {
return "";
}
}catch (e9063){var _ = e9063;
return "";
}});
...
try{var o__8142__auto___9065 = t;
(o__8142__auto___9065["cljs$lang$ctorPrWriter"]).call(o__8142__auto___9065,t,writer);
}catch (e9064){var __9066 = e9064;
}
...
var char_code = (function (){var o__8142__auto__ = (new String(char$));
return (o__8142__auto__["charCodeAt"]).call(o__8142__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__8142__auto__ = String;
return (o__8142__auto__["fromCharCode"]).call(o__8142__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__9067 = num_code;
switch (G__9067) {
case (1):
return (185);
...
var o__8142__auto__ = String;
return (o__8142__auto__["fromCharCode"]).call(o__8142__auto__,superscript_code);
});
/**
...
}catch (e9069){var _e__8149__auto__ = e9069;
return false;
}})())){
...
var vec__9070 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__9070,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o9073 = temp__5455__auto__;
var temp__5455__auto____$1 = (o9073["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o9074 = temp__5455__auto____$1;
return (o9074["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___9081 = arguments.length;
var i__4532__auto___9082 = (0);
while(true){
if((i__4532__auto___9082 < len__4531__auto___9081)){
args__4534__auto__.push((arguments[i__4532__auto___9082]));

var G__9083 = (i__4532__auto___9082 + (1));
i__4532__auto___9082 = G__9083;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__9077){
var vec__9078 = p__9077;
var ns_detector = cljs.core.nth.call(null,vec__9078,(0),null);
...
var G__9084 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__9085 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__9084;
remaining_tokens = G__9085;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq9075){
...
var vec__9089 = cljs.core.split_with.call(null,(function (p1__9088_SHARP_){
return cljs.core.not_EQ_.call(null,p1__9088_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__9089,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__9089,(1),null);
...
var vec__9092 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__9092,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__9092,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__9095 = cljs.core.rest.call(null,remaining_tokens);
var G__9096 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__9095;
name_tokens = G__9096;
continue;
} else {
...
var vec__9099 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__9099,(0),null);
var arity = cljs.core.nth.call(null,vec__9099,(1),null);
var vec__9102 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__9102,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__9102,(1),null);
var vec__9105 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__9105,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__9105,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__9105,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__9105,(3),null);
...
var vec__9111 = result;
var munged_ns = cljs.core.nth.call(null,vec__9111,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__9111,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__9111,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__9111,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__9111,(4),null);
var arity = cljs.core.nth.call(null,vec__9111,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__9115 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__9115,(0),null);
var args = cljs.core.nth.call(null,vec__9115,(1),null);
var vec__9118 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__9118,(0),null);
var name = cljs.core.nth.call(null,vec__9118,(1),null);
...
var G__9121 = (arity + (1));
var G__9122 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__9123){
var vec__9124 = p__9123;
var arity = cljs.core.nth.call(null,vec__9124,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__9124,(1),null);
...
return cljs.core.get.call(null,arities,p1__9127_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__9128_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__9131){
var vec__9132 = p__9131;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__9132,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq9129){
...
var map__9140 = options;
var map__9140__$1 = ((((!((map__9140 == null)))?(((((map__9140.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9140.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9140):map__9140);
var include_ns_QMARK_ = cljs.core.get.call(null,map__9140__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__9140__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__9140__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__9140__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__9141 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__9141,(0),null);
var fn_name = cljs.core.nth.call(null,vec__9141,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__9141,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__9141,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__9141,(4),null);
var arity = cljs.core.nth.call(null,vec__9141,(5),null);
...
var o__8142__auto__ = f;
return (o__8142__auto__["getBasis"]).call(o__8142__auto__);
});
/**
...
}catch (e9145){var _e__8149__auto__ = e9145;
...
var G__9146 = (obj[cljs.core.first.call(null,path)]);
var G__9147 = cljs.core.rest.call(null,path);
obj = G__9146;
path = G__9147;
continue;
} else {
...
return (function (accum,p__9148){
var vec__9149 = p__9148;
var bit = cljs.core.nth.call(null,vec__9149,(0),null);
var protocol = cljs.core.nth.call(null,vec__9149,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__9152){
var vec__9153 = p__9152;
var ns = cljs.core.nth.call(null,vec__9153,(0),null);
var name = cljs.core.nth.call(null,vec__9153,(1),null);
var selector = cljs.core.nth.call(null,vec__9153,(2),null);
...
return (function (p__9157){
var vec__9158 = p__9157;
var munged_name = cljs.core.nth.call(null,vec__9158,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__9158,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__9158,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__9156_SHARP_){
return (obj[cljs.core.first.call(null,p1__9156_SHARP_)]);
});})(name,sorted_matches,vec__9158,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
